...
import CircularStdBoldItalic from "./fonts/CircularStd-BoldItalic.otf";
import CircularStdBook from "./fonts/CircularStd-Book.otf";
import CircularStdBookItalic from "./fonts/CircularStd-BookItalic.otf";
import CircularStdLight from "./fonts/CircularStd-Light.otf";
import CircularStdLightItalic from "./fonts/CircularStd-LightItalic.otf";
import CircularStdMedium from "./fonts/CircularStd-Medium.otf";
import CircularStdMediumItalic from "./fonts/CircularStd-MediumItalic.otf";
...
const GlobalStyles = createGlobalStyle`
    ...
    @font-face {
        ...
        src: url(${CircularStdLightItalic}) format('opentype');
    }
    ...
    @font-face {
        ...
        src: url(${CircularStdBlackItalic}) format('opentype');
    }
